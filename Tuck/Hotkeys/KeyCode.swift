...
nonisolated struct KeyCode: RawRepresentable, Codable, Hashable {
    let rawValue: Int
...
nonisolated extension KeyCode {
    /// The system's textual representation of this key, derived from the
...
private nonisolated let customStringMappings: [KeyCode: String] = [
    // standard keys
    .space: "Space",
    .tab: "⇥",
    .return: "⏎",
    ...
    .keypadEnter: "⌤",
    // media keys
    .volumeUp: "\u{1F50A}",   // 'SPEAKER WITH THREE SOUND WAVES'
    .volumeDown: "\u{1F509}", // 'SPEAKER WITH ONE SOUND WAVE'
...
nonisolated extension KeyCode {
    /// A string representation of this key, suitable for display.
    var stringValue: String {
        customStringMappings[self, default: keyEquivalent.uppercased()]
    }
}
